            ...
            >
                ...
                >
                    <a
                        ...
                        href="https://praiseimmanuel.netlify.app/"
                        target="_blank"
                    >
                        <img
                            className="round"
                            src="https://avatars.githubusercontent.com/u/99152269?s=96&v=4"
                            alt="avatar"
                        />
                    </a>
                </div>
...
const mapStateToProps = (state) => {
    return {
        visibility: state.display.visibility,
        opacity: state.display.opacity,
    };
};
